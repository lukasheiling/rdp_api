...
@app.get("/devices/with-values/", response_model=List[ApiTypes.DeviceWithValues])
def get_devices_with_values():
    """Endpoint, um alle Geräte mit ihren zugehörigen Werten zu erhalten"""
    try:
        devices = crud.get_devices_with_values()
        return devices
